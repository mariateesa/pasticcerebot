"""
Test del modulo agent di PasticcereBot (versione locale Ollama).
Testa la logica interna (memoria, preparazione messaggi) senza avviare Ollama.
...
def test_salva_risposta_accoda_messaggi():
    """Piu' risposte devono accumularsi nell'ordine corretto."""
    reset_memoria(CHAT_A)
